      ...
      <div className="container mx-auto px-6 max-w-6xl z-10 flex-grow flex items-center py-12">
        ...
        >
          ...
          <div className="lg:col-span-7 space-y-8 text-left">
            ...
            >
              A private space to write down your thoughts, trace emotional patterns, play gamified Clarity Quests to sharpen your expression, and schedule encrypted letters to the future. Built on Celo with modular AI tools to support your reflection, not write for you.
            </motion.p>
