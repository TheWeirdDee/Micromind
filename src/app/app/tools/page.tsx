...
import { MessageSquare, Bird, Sparkles, Search, Brain, Flame, Feather, PenLine, Lock, HelpCircle } from 'lucide-react';
...
const TOOL_SLUGS = ['chat', 'tweet', 'reflect', 'pattern', 'coach', 'challenge', 'stories', 'therapeutic'];
