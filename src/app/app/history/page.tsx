      ...
      <div className="space-y-4">
        {history.length === 0 ? (
          ...
          history.map((item) => {
            ...
            return (
              <div key={item.id} className="bg-surface-2 border border-border rounded-2xl p-6 space-y-4 group hover:border-text-muted/40 transition-colors">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-[10px] font-mono text-text-muted uppercase tracking-wider">
                        {new Date(item.timestamp).toLocaleDateString()} · {item.cost} cUSD
                      </p>
                    </div>
                  </div>
                  <a 
