...
contract MicroMindPayment is Ownable, ReentrancyGuard {
    ...
    constructor(address _cUSD) Ownable(msg.sender) {
        cUSD = IERC20(_cUSD);
        toolPrices[TOOL_CHAT]   = 0.01 ether;
        toolPrices[TOOL_RESUME] = 0.05 ether;
        toolPrices[TOOL_TWEET]  = 0.01 ether;
        toolPrices[TOOL_BIO]    = 0.02 ether;
    }
    ...
    function payForPrompt(uint8 toolId, bytes32 promptHash) 
        ...
        emit PromptPaid(msg.sender, toolId, promptHash, 
